...
.method private markAllAsInstalledForUser(ILcom/android/server/pm/Installer;)V
    ...
    invoke-virtual {p0, v7, v4}, Lcom/android/server/pm/Settings;->wasPrebundledPackageInstalledLPr(ILjava/lang/String;)Z

    move-result v3

    .local v3, "setInstalled":Z
    invoke-virtual {v1, v3, p1}, Lcom/android/server/pm/PackageSetting;->setInstalled(ZI)V
    ...
    iget-object v6, v1, Lcom/android/server/pm/PackageSetting;->pkg:Landroid/content/pm/PackageParser$Package;
    ...
    invoke-virtual {p2, v4, v5, p1, v6}, Lcom/android/server/pm/Installer;->createUserData(Ljava/lang/String;IILjava/lang/String;)I

    goto :goto_1

    .end local v1    # "ps":Lcom/android/server/pm/PackageSetting;
    .end local v3    # "setInstalled":Z
    :cond_3
...
.method createNewUserLILPw(Lcom/android/server/pm/PackageManagerService;Lcom/android/server/pm/Installer;ILjava/io/File;)V
    ...
    invoke-virtual {p0, v3, v4}, Lcom/android/server/pm/Settings;->wasPrebundledPackageInstalledLPr(ILjava/lang/String;)Z
    ...
    invoke-virtual {p2, v4, v5, p3, v6}, Lcom/android/server/pm/Installer;->createUserData(Ljava/lang/String;IILjava/lang/String;)I

    goto :goto_0

    .end local v2    # "setInstalled":Z
    :cond_2
    move v2, v3
...
.method readPrebundledPackagesOldLPw()V
    ...
    iget-object v1, p0, Lcom/android/server/pm/Settings;->mPrebundledPackagesFilename:Ljava/io/File;

    invoke-direct {p0, v0, v1}, Lcom/android/server/pm/Settings;->readPrebundledPackagesForUserFromFileLPr(ILjava/io/File;)V
...
.method shouldPrebundledPackageBeInstalled(Landroid/content/res/Resources;Ljava/lang/String;Landroid/content/res/Resources;)Z
    .locals 5

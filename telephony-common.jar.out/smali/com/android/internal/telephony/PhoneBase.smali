...
.method protected constructor <init>(Ljava/lang/String;Lcom/android/internal/telephony/PhoneNotifier;Landroid/content/Context;Lcom/android/internal/telephony/CommandsInterface;ZI)V
    ...
    .line 274
    iput v5, p0, Lcom/android/internal/telephony/PhoneBase;->mRadioAccessFamily:I
    ...
    invoke-interface {v2, p0, v3, v6}, Lcom/android/internal/telephony/CommandsInterface;->registerForSrvccStateChanged(Landroid/os/Handler;ILjava/lang/Object;)V
    ...
    invoke-interface {v2, p0, v3, v6}, Lcom/android/internal/telephony/CommandsInterface;->setOnUnsolOemHookRaw(Landroid/os/Handler;ILjava/lang/Object;)V
...
.method public handleMessage(Landroid/os/Message;)V
    ...
    const-string v8, "Event EVENT_INITIATE_SILENT_REDIAL Received"
    ...
    :try_start_0
    invoke-virtual {p0, v2, v7, v8}, Lcom/android/internal/telephony/PhoneBase;->dialInternal(Ljava/lang/String;Lcom/android/internal/telephony/UUSInfo;I)Lcom/android/internal/telephony/Connection;
    :try_end_0
    ...
    const-string v9, "silent redial failed: "
    ...
    const-string v9, "Srvcc exception: "
    ...
    const-string v9, "EVENT_UNSOL_OEM_HOOK_RAW data="
    ...
    const-string v9, "OEM hook raw exception: "
    ...
    const-string v9, "Event EVENT_PHONE_RAT_FAMILY_CHANGED_NOTIFY "

    invoke-virtual {v8, v9}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    move-result-object v8

    iget-object v9, p0, Lcom/android/internal/telephony/PhoneBase;->mPhoneRatFamilyChangedRegistrants:Landroid/os/RegistrantList;
    ...
    check-cast v7, Landroid/telephony/PhoneRatFamily;

    move-object v5, v7

    check-cast v5, Landroid/telephony/PhoneRatFamily;

    .line 641
    .local v5, "rat":Landroid/telephony/PhoneRatFamily;
    const-string v7, "PhoneBase"
    ...
    const-string v9, "update mPhoneRatFamily, "
    ...
    iput v7, p0, Lcom/android/internal/telephony/PhoneBase;->mPhoneRatFamily:I

    .line 645
    .end local v5    # "rat":Landroid/telephony/PhoneRatFamily;
    :cond_6
    ...
    const-string v8, "get phone radio capability fail,no need to change mRadioAccessFamily"
    ...
    .line 655
    .local v4, "radioCapability":Lcom/android/internal/telephony/RadioCapability;
    invoke-virtual {v4}, Lcom/android/internal/telephony/RadioCapability;->getRadioAccessFamily()I

    move-result v7

    iput v7, p0, Lcom/android/internal/telephony/PhoneBase;->mRadioAccessFamily:I
    ...
    const-string v9, "EVENT_GET_RADIO_CAPABILITY :phone "
    ...
    iget v9, p0, Lcom/android/internal/telephony/PhoneBase;->mRadioAccessFamily:I
...
.method public setRadioCapability(Lcom/android/internal/telephony/RadioCapability;Landroid/os/Message;)V
    .locals 1
    .param p1, "radioCapability"    # Lcom/android/internal/telephony/RadioCapability;
